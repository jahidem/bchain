...
async function main() {
    ...
    // Load the contract
    const basicContract = await hre.ethers.getContractAt("BasicMedicalContract", "0x5FbDB2315678afecb367f032d93F642f64180aa3");
    ...
    fs.writeFileSync(
        path.join(__dirname, "performanceBasic.json"),
